...
#### Claude Code CLI (개발자 인터랙티브 세션)
| 용도 | 모델 | 모델 ID |
|------|------|---------|
| 학습·단순 질문 | Haiku 4.5 | `claude-haiku-4-5-20251001` |
| 일반 코딩·균형 | Sonnet 4.6 | `claude-sonnet-4-6` |
| 복잡한 설계·디버깅 | Opus 4.6 | `claude-opus-4-6` |

#### OpenClaw 에이전트 내부 (3-Model Economy, $50/월)
| 용도 | 모델 | 에이전트 수 |
|------|------|------------|
| 코딩·오케스트레이션 | Haiku 4.5 (`claude-haiku-4-5-20251001`) | 12개 |
| 대량처리·문서·OCR | Gemini 2.5 Flash (`gemini-2.5-flash-preview-05-20`) | 14개 |
| 수학·과학 추론 ⚠️PII금지 | Kimi K2.5 (`kimi-k2.5`) | 2개 |
